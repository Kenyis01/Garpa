    ...
    return (
      ...
      >
        ...
        <View style={styles.balanceContainer}>
          {hasBalance ? (
            <>
              <Text style={[styles.balanceText, { color: item.myBalance > 0 ? Colors.brand.primary : Colors.brand.orange }]}>
                {item.myBalance > 0 ? 'you are owed' : 'you owe'}
              </Text>
              <Text style={[styles.balanceAmount, { color: item.myBalance > 0 ? Colors.brand.primary : Colors.brand.orange }]}>
    ...
    <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity style={styles.createBigBtn} onPress={() => router.push('/create-group')}>
