        ...
        options={{
          ...
          headerRight: () => (
             <TouchableOpacity onPress={handleFinish}>
                <Text style={{color: Colors.brand.primary, fontWeight:'bold', fontSize: 16}}>Add friends</Text>
             </TouchableOpacity>
          )
        }} 
      />
      ...
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
            <Text style={styles.disclaimer}>
                These people will be notified you've added them.
            </Text>
...
const styles = StyleSheet.create({
    ...
    avatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#ccc', alignItems: 'center', justifyContent: 'center', marginRight: 15 },
    name: { fontWeight: '600', fontSize: 16 },
    detail: { color: '#666' },
    footer: { marginTop: 'auto', marginBottom: 20 },
    disclaimer: { color: '#888', textAlign: 'center', marginBottom: 15, fontSize: 12 },
    confirmButton: { backgroundColor: Colors.brand.primary, padding: 15, borderRadius: 8, alignItems: 'center' },
