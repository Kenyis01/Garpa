...
export default function SettleUpScreen() {
  const { friendId, friendName, balance: balanceStr } = useLocalSearchParams<{
    friendId: string;
    friendName: string;
    balance: string;
  }>();
    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity onPress={() => setAmount(suggestedAmount)} style={styles.fullAmountBtn}>
            <Text style={styles.fullAmountBtnText}>
              Use full amount (${suggestedAmount})
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <Text style={styles.disclaimer}>
          This records the payment in Garpa but doesn't actually send money.
          Use Venmo, bank transfer, or cash to complete the payment.
        </Text>
      </ScrollView>
    </>
  );
